  ...
  return (
    <div className="app">
      ...
      <section>
        ...
        <button onClick={() => setMostrarExperimento(!mostrarExperimento)}>
          {mostrarExperimento ? 'Ocultar experimento' : 'Mostrar experimento'}
        </button>
...
function ContadorAutomatico() {
  ...
  useEffect(() => {
    const id = setInterval(() => {
      setContador((prev) => {
        console.log('El contador según el efecto es:', prev + 1);
        return prev + 1;
      });
    }, 1000);
